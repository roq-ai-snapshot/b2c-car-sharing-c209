  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of B2C Car Sharing. Book cars near you, efficiently managed by our dedicated operations staff from centralized dashboards."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of B2C Car Sharing. Book cars near you, efficiently managed by our dedicated operations staff from centralized dashboards.`}
            </Text>
            <Box
